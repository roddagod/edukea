...
export const metadata = { title: 'Matières & coefficients — Rentrée' };
    ...
    <div className="p-4 md:p-6 lg:p-8">
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl font-semibold text-slate-900 md:text-3xl">Matières &amp; coefficients</h1>
          <p className="text-sm text-slate-600">
            Configurez les matières enseignées et leurs coefficients par niveau. Étape indispensable pour les bulletins.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50 p-8 text-center">
        ...
        <p className="mx-auto mt-2 max-w-md text-sm text-slate-600">
          Le module de configuration des matières et coefficients arrive dans le prochain sprint (S3D.3 / S3D.4).
          Il permettra de définir par niveau : matières enseignées, coefficients, notation par période, moyennes calculées.
        </p>
